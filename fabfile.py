"""
Starter fabfile for deploying the movie_app project.
...
# CHANGEME
env.hosts = ['user@movie_app.example.com']
env.code_dir = '/srv/www/movie_app'
env.project_dir = '/srv/www/movie_app/movie_app'
env.static_root = '/srv/www/movie_app/static/'
env.virtualenv = '/srv/www/movie_app/.virtualenv'
env.code_repo = 'git@github.com:user/movie_app.git'
env.django_settings_module = 'movie_app.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/movie_app/wsgi.py" % env.code_dir)
