...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'movie_app.settings.base.custom_show_toolbar',
...
SYSTEM_EMAIL_PREFIX = "[movie_app]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_movie_app"  # Make this unique to your project.
